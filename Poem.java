...
public class Poem
{
    public static void main(String[] args)
    {
        ...
        out.println("'Twas brillig, and the slighy toves");
        ...
        out.println("Came whiffling though the tulgey wood,");
        out.println("   And burbled as it came! \n");
        
        out.println("One, two! One, two! And though and through");
        ...
        out.println("\"And hast thou slain the Jannerwork?");
